...
#define LCD_SDA_GPIO_PIN				GPIO_Pin_10              //
...
void LCD_ShowChinese12x12(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey,u8 mode);//显示单个12x12汉字fc：字的颜色，字的背景
...
void LCD_ShowFloatNum1(u16 x, u16 y, float num, u8 len, u16 fc, u16 bc, u8 sizey);//显示一位小数的变量
void LCD_ShowHexNum(u16 x, u16 y, u32 num, u8 len, u16 fc, u16 bc, u8 sizey);

void LCD_ShowPicture(u16 x,u16 y,u16 length,u16 width,const u8 pic[]);//显示图片

void LCD_Fill_Inverted(u16 x1, u16 y1, u16 x2, u16 y2, u16 color); // 区域反相填充，color颜色是背景色
void LCD_ShowChinese_Inverse(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey); // 带背景反转的汉字显示
void LCD_ShowString_Inverse(u16 x,u16 y,const u8 *p,u16 fc,u16 bc,u8 sizey); // 带背景反转的字符串显示
